...
(function _anonymous_1(global, factory) {
 ...
 return _; };
  ...
  if (typeof Set !== 'undefined' && isNative(Set)) {
    ...
    _Set = /*@__PURE__*/(function _anonymous_17() {
    var necooData = window.necooPushCallStack(arguments);
...

  {
    ...
    var necooData = window.necooPushCallStack(arguments);
 return str
      .replace(classifyRE, function _anonymous_19(c) {
    var necooData = window.necooPushCallStack(arguments);
 return c.toUpperCase(); })
    ...
    var necooData = window.necooPushCallStack(arguments);
      ...
      if (vm._isVue && vm.$parent) {
        ...
        return '\n\nfound in\n\n' + tree
          .map(function _anonymous_25(vm, i) {
    var necooData = window.necooPushCallStack(arguments);
 ...
 return a.id - b.id; });
  ...
  strats.data = function _anonymous_31(
    parentVal,
    childVal,
    vm
  ) {
   ...
   */
  strats.watch = function _anonymous_34(
    parentVal,
    childVal,
    vm,
    key
  ...
  strats.methods =
  strats.inject =
  strats.computed = function _anonymous_35(
    parentVal,
    childVal,
    vm,
    key
 ...
 return this._props };
    ...
    Vue.prototype.$watch = function _anonymous_93(
      expOrFn,
      cb,
      options
    ) {
  ...
  function initAssetRegisters (Vue) {
    ...
    var necooData = window.necooPushCallStack(arguments);
      ...
      Vue[type] = function _anonymous_100(
        id,
        definition
      ) {
    var necooData = window.necooPushCallStack(arguments);
 ...
 return tag === 'pre'; };
    ...
    var necooData = window.necooPushCallStack(arguments);
      ...
      return (
        ...
        !(
          ...
          config.ignoredElements.some(function _anonymous_116(ignore) {
    var necooData = window.necooPushCallStack(arguments);
  ...
  function pluckModuleFunction (
    ...
    return modules
      ? modules.map(function _anonymous_120(m) {
    var necooData = window.necooPushCallStack(arguments);
 return m[key]; }).filter(function _anonymous_121(_) {
    var necooData = window.necooPushCallStack(arguments);
 return _; })
      : []
  }
  ...
  function genSelect (
    ...
    var selectedVal = "Array.prototype.filter" +
      ".call($event.target.options,function _anonymous_123(o){return o.selected})" +
      ".map(function _anonymous_124(o){var val = \"_value\" in o ? o._value : o.value;" +
 ...
 return el.classList.remove(c); });
  ...
  var raf = inBrowser
    ? window.requestAnimationFrame
      ...
      : setTimeout
    : /* istanbul ignore next */ function _anonymous_133(fn) {
    var necooData = window.necooPushCallStack(arguments);
 return fn(); };
 ...
 return !looseEqual(o, prevOptions[i]); })) {
          ...
          var needReset = el.multiple
            ? binding.value.some(function _anonymous_148(v) {
    var necooData = window.necooPushCallStack(arguments);
 ...
 removeClass(clone, cls); });
  ...
  // public mount method
  Vue.prototype.$mount = function _anonymous_162(
    el,
    hydrating
  ) {
    var necooData = window.necooPushCallStack(arguments);
 ...
 return ("if(" + condition + ")return null;"); };
  ...
  function genHandler (handler) {
    ...
    var necooData = window.necooPushCallStack(arguments);
 return genHandler(handler); }).join(',')) + "]")
    }
      ...
      for (var key in handler.modifiers) {
        if (modifierCode[key]) {
          ...
          genModifierCode += genGuard(
            ['ctrl', 'shift', 'alt', 'meta']
              .filter(function _anonymous_178(keyModifier) {
    var necooData = window.necooPushCallStack(arguments);
 ...
 return !!el.component || !isReservedTag(el.tag); };
  ...
  function genFor (
    ...
    return (altHelper || '_l') + "((" + exp + ")," +
      "function _anonymous_184(" + alias + iterator1 + iterator2 + "){" +
  ...
  function genInlineTemplate (el, state) {
    ...
    var necooData = window.necooPushCallStack(arguments);
 return ("function _anonymous_187(){" + code + "}"); }).join(',')) + "]}")
    }
  }
  ...
  function genScopedSlots (
    ...
    var generatedSlots = Object.keys(slots)
      .map(function _anonymous_189(key) {
    var necooData = window.necooPushCallStack(arguments);
 return genScopedSlot(slots[key], state); })
  ...
  function genScopedSlot (
    ...
    var slotScope = el.slotScope === emptySlotScopeToken
      ? ""
      : String(el.slotScope);
    var fn = "function _anonymous_190(" + slotScope + "){" +
  ...
  function getNormalizationType (
    ...
    for (var i = 0; i < children.length; i++) {
      ...
      if (needsNormalization(el) ||
          (el.ifConditions && el.ifConditions.some(function _anonymous_192(c) {
    var necooData = window.necooPushCallStack(arguments);
 return needsNormalization(c.block); }))) {
      ...
      if (maybeComponent(el) ||
          (el.ifConditions && el.ifConditions.some(function _anonymous_193(c) {
    var necooData = window.necooPushCallStack(arguments);
 return maybeComponent(c.block); }))) {
  ...
  function genSlot (el, state) {
    ...
    var attrs = el.attrs || el.dynamicAttrs
      ? genProps((el.attrs || []).concat(el.dynamicAttrs || []).map(function _anonymous_194(attr) {
    var necooData = window.necooPushCallStack(arguments);
 return ({
 ...
 return tip(msg, vm); });
  ...
  Vue.prototype.$mount = function _anonymous_204(
    el,
    hydrating
  ) {
    var necooData = window.necooPushCallStack(arguments);
