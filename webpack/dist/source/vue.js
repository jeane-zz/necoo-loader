...
var extendStatics = function _anonymous_1(d, b) {
    ...
    extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function _anonymous_2(d, b) {
    var necooData = window.necooPushCallStack(arguments);
 d.__proto__ = b; }) ||
...
function getMapLikeKeys(map) {
    ...
    if (Array.isArray(map))
        return map.map(function _anonymous_11(_a) {
    var necooData = window.necooPushCallStack(arguments);
...
var Atom = /** @class */ (function _anonymous_12() {
    var necooData = window.necooPushCallStack(arguments);
...
var ObservableValue = /** @class */ (function _anonymous_31(_super) {
    var necooData = window.necooPushCallStack(arguments);
 ...
 */
var ComputedValue = /** @class */ (function _anonymous_43() {
    var necooData = window.necooPushCallStack(arguments);
...
var CaughtException = /** @class */ (function _anonymous_64() {
    var necooData = window.necooPushCallStack(arguments);
...
var MobXGlobals = /** @class */ (function _anonymous_65() {
    var necooData = window.necooPushCallStack(arguments);
...
function printDepTree(tree, lines, depth) {
    ...
    if (tree.dependencies)
        tree.dependencies.forEach(function _anonymous_71(child) {
    var necooData = window.necooPushCallStack(arguments);
 return printDepTree(child, lines, depth + 1); });
}

var Reaction = /** @class */ (function _anonymous_72() {
    var necooData = window.necooPushCallStack(arguments);
...
function decorate(thing, decorators) {
    ...
    var necooData = window.necooPushCallStack(arguments);
        ...
        process.env.NODE_ENV !== "production" &&
            invariant(propertyDecorators.every(function _anonymous_109(decorator) {
    var necooData = window.necooPushCallStack(arguments);
 return typeof decorator === "function"; }), "Decorate: expected a decorator function or array of decorator functions for '" + prop + "'");
        var descriptor = Object.getOwnPropertyDescriptor(target, prop);
        var newDescriptor = propertyDecorators.reduce(function _anonymous_110(accDescriptor, decorator) {
    var necooData = window.necooPushCallStack(arguments);
 return decorator(target, prop, accDescriptor); }, descriptor);
        if (newDescriptor)
...
var ObservableArrayAdministration = /** @class */ (function _anonymous_142() {
    var necooData = window.necooPushCallStack(arguments);
...
[
    ...
    "toString",
    "toLocaleString"
].forEach(function _anonymous_173(funcName) {
    var necooData = window.necooPushCallStack(arguments);
...
var ObservableMap = /** @class */ (function _anonymous_175() {
    var necooData = window.necooPushCallStack(arguments);
    ...
    var necooData = window.necooPushCallStack(arguments);
            ...
            if (isPlainObject(other))
                getPlainObjectKeys(other).forEach(function _anonymous_196(key) {
    var necooData = window.necooPushCallStack(arguments);
 return _this.set(key, other[key]); });
            else if (Array.isArray(other))
                other.forEach(function _anonymous_197(_a) {
    var necooData = window.necooPushCallStack(arguments);
    ...
    var necooData = window.necooPushCallStack(arguments);
        ...
        return (this.name +
            ...
            Array.from(this.keys())
                .map(function _anonymous_211(key) {
    var necooData = window.necooPushCallStack(arguments);
...
var ObservableSet = /** @class */ (function _anonymous_214() {
    var necooData = window.necooPushCallStack(arguments);
...
var ObservableObjectAdministration = /** @class */ (function _anonymous_241() {
    var necooData = window.necooPushCallStack(arguments);
